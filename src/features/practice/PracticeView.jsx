...
export default function PracticeView({ route, onOpenCard }) {
  ...
  if (route.scenarioId === 'play' || route.scenarioId === 'game') return <Game mode={route.scenarioId} />
    ...
    <div className="stack">
      ...
      <section className="hero">
        ...
        <div className="row row--wrap">
          ...
          <button className="btn btn--sm" onClick={() => navigate({ scenarioId: 'play' })}>Play a whole game</button>
        </div>
      </section>
...
function Scenario({ scenario, onOpenCard }) {
  ...
  return (
    <div className={`stack practice ${reduced ? 'practice--still' : ''}`}>
      ...
      <div className="practice__journal" role="log" aria-live="polite" aria-atomic="false" aria-label="What just happened">
